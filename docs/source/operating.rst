[myawesometmlsolution-5e37] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-5e37] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-5e37] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/franklinen/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45783  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='franklinen'  \-\-env DOCKERUSERNAME='frank19831207'  \-\-env MQTTUSERNAME='franklinen'  \-\-env KAFKACLOUDUSERNAME='<Enter API key>'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   Refer to the original solution container and documenation here: https://myawesometmlsolution-5e37.readthedocs.io/en/latest/operating.html
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=myawesometmlsolution-5e37 \
          --env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-5e37 \
          ...
          frank19831207/myawesometmlsolution-5e37-amd64:latest
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - frank19831207/myawesometmlsolution-5e37-amd64
...
[myawesometmlsolution-5e37] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/franklinen/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-5e37
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-5e37
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=45085, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=33497, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=44445, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=34227, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=39579, HPDEHOST=172.17.0.2, HPDEPORT=35047, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=41605

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-558-myawesometmlsolution-5e37,solution_preprocessing_dag-myawesometmlsolution-5e37, python-preprocess-8823-myawesometmlsolution-5e37,solution_preprocessing_dag-myawesometmlsolution-5e37, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
