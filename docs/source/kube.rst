Scaling [myawesometmlsolution-5e37] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolution-5e37] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolution-5e37.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolution-5e37.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolution-5e37.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolution-5e37.yml

myawesometmlsolution-5e37.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolution-5e37.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/franklinen/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-5e37/ymls/myawesometmlsolution-5e37
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolution-5e37.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolution-5e37
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolution-5e37
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolution-5e37
             image: frank19831207/myawesometmlsolution-5e37-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'myawesometmlsolution-5e37'                              
             - name: SOLUTIONNAME
               value: 'myawesometmlsolution-5e37'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-myawesometmlsolution-5e37'
             - name: GITUSERNAME
               value: 'franklinen'
             - name: GITREPOURL
               value: 'https://github.com/franklinen/raspberrypi.git'
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolution-5e37-visualization-service
       labels:
         app: myawesometmlsolution-5e37-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolution-5e37 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolution-5e37.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolution-5e37.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolution-5e37.yml
